        ...
        <div className="w-full lg:w-2/3 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#1e293b] p-6 rounded-2xl border border-white/5 space-y-4">
              <div className="flex items-center gap-4">
                ...
                <p className="text-sm truncate">lic.montalvo.legal@gmail.com</p>
              </div>
              <button 
            ...
            <div className="flex items-center justify-center italic text-[#d4a017] text-xl font-serif p-4 text-center">
          ...
          <form onSubmit={handleSubmit} className="bg-[#1e293b] p-8 rounded-2xl border border-[#d4a017]/10 space-y-4">
            <input 
              ...
              placeholder="NOMBRE" 
              required 
              className="w-full bg-[#374151] border border-white/10 p-4 rounded-xl focus:border-[#d4a017] outline-none text-white" 
            ...
            <textarea 
              ...
              rows={4} 
              required 
              className="w-full bg-[#374151] border border-white/10 p-4 rounded-xl focus:border-[#d4a017] outline-none resize-none text-white" 
              onChange={(e) => setFormData({...formData, mensaje: e.target.value})}
            ></textarea>
            <button 
              type="submit" 
              className="w-full md:w-auto px-10 py-4 bg-[#d4a017] text-black font-bold uppercase tracking-widest rounded-xl hover:bg-white transition-all flex items-center justify-center gap-2"
            >
